...
<!-- Modal dialog -->
<div id="DeleteModalSupplier" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="DeleteModalLabel"
     aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <g:form>
                    ...
                    <span class="button"><g:actionSubmit class="btn btn-danger" action="deleteSupplier"
