        ...
        <div class="modal-content">
            <g:form controller="login" action="register" class="form-horizontal" method="post" name="register_form">
                <div class="modal-header">
                    ...
                    <h3><g:message code="user.register.title"/></h3>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 control-label"
                               for="confirmpasswd">${message(code: 'security.password.confirm.label', default: 'Confirm')}</label>

                        <div class="col-lg-10">
                            <input class="form-control" name="confirmpasswd" id="confirmpasswd" type="password"
