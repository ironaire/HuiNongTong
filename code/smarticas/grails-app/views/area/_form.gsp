...
<div class='col-xs-4'>
	<g:field class='form-control' name="level" type="number" min="0" value="${areaInstance.level}"/>
...
<div class='col-xs-4'>
	<g:textArea class='form-control' name="reserve1" cols="40" rows="5" maxlength="256" value="${areaInstance?.reserve1}"/>
...
<div class='col-xs-4'>
	<g:textArea class='form-control' name="reserve2" cols="40" rows="5" maxlength="256" value="${areaInstance?.reserve2}"/>
...
<div class='col-xs-4'>
	<g:textArea class='form-control' name="reserve3" cols="40" rows="5" maxlength="256" value="${areaInstance?.reserve3}"/>
